...
In our project, we use two typical collaborative filtering system models to perform benchmarking, powered by the programming model mentioned in the next section. These two collaborative filtering system models are:
...
`X` is the latent vectors for reviewers, `Y` is the latent vectors for products. `XY` is the joint table with rating predictions. `XY_train` is the folder to be used for the nerual network. Predictions100 is our prediction for 100 users.
...
<p float="left">
  ...
  <img src="./fig/B00LUCO52G.png" width="200" /> 
  <img src="./fig/B00LYLHUNE.png" width="200" />
  <img src="./fig/B00M13FNSS.png" width="200" />
</p>
