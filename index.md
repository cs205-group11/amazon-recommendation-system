...
To get started, follow [Guide: First Access to AWS  
](https://docs.google.com/document/d/1pbawfF3BNtT4iviQ5ZcMwNi9DNxjcZCqIQxcN1afV8I/edit) to create AWS account and key pairs for remote log in.
...
```
6. Decompress the rating data using `gzip`
```
...
11. You should see some newly generated folder in the hdfs.
```
hadoop fs -ls
```
